 ...
 * This scripts crate the SIXONE field hostpital.
 ...
 *
 * Example:
 * [this] call sixone_fnc_doFieldHospital;
 * [this, true, 1] call sixone_fnc_doFieldHospital;
 */
...
_crate addAction ["<img image='scripts\Data\Icon\icon_00.paa' /> SIXONE Field Hospital", {}, [], 1.5, true, true, "", "true", 5];
