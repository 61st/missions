/*
    ...
    Returns:
        NOTHING
*/
#include "..\config\config_admins.hpp" // set up admin list

admp_authorisedIDs = [];
{admp_authorisedIDs pushBackUnique _x;} forEach ["_SP_AI_", "_SP_PLAYER_"]; // Make sure JohnnyShootos & TheTimidShade always have admin access for redundancy
...
admp_utilities_sixone_enabledUnits = [];
