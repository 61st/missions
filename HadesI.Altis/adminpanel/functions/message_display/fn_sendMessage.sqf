...
// if the message is a general announcement set sender name to 'SIXONE Admin' instead
private _senderName = name player;
if (_recipient in ["AllPlayers", "AllAlive", "AllDead"]) then {_senderName = "SIXONE Admin";};
