...
if (_unitIndex isEqualTo -1) exitWith {
	...
	private _text = format ["
		...
		",
		((SIXONE_dynamicGroups select _groupIndex) select 0)
	];
...
",
	_roleName,_roleDesc,
	localize "STR_SIXONE_Role_Menu_Default_Loadout",localize "STR_A3_RSCDISPLAYGEAR_FILTERS_PRIMARY0",_defaultLoadoutText#0,localize "STR_A3_RSCDISPLAYARSENAL_TAB_SECONDARYWEAPON",
