...
def main():
    ...
    rootDir = "../dev missions\DaggerIslandTrainingComplex_vE.dagger_island_summer_no_targets"
    if (os.path.exists("dev missions\DaggerIslandTrainingComplex_vE.dagger_island_summer_no_targets")):
        rootDir = "dev missions\DaggerIslandTrainingComplex_vE.dagger_island_summer_no_targets"
