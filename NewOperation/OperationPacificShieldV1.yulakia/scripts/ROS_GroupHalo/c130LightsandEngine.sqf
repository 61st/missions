...
// This is run locally on all clients via C130 init field
// [this] execvm "ROS_GroupHalo\c130LightsandEngine.sqf";
...
lightR = "#lightpoint" createVehicle position _plane;
