...
this addAction ["<t color='#b2ff66'>Move C130</t>",{[C130] execVM "ROS_GroupHalo\ROS_MoveHaloPlane.sqf"},[],1.4,false,false,"","player distance _target <3 && count (((position C130) nearObjects ['CAManBase', 10]) select {alive _x}) ==0"];
