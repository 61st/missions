...
// Interaction system
private _condition1 = { [player] call FUNC(isNearFOB) };
private _condition2 = { isNull objectParent player && [player] call FUNC(isNearFOB) };
private _condition3 = { isNull objectParent player && {player getVariable ["ace_arsenal_virtualItems",[]] isNotEqualTo [] && [player] call FUNC(isNearFOB)} };
...
private _category = ["ACE_SelfActions", "StagingCategory"];
...
[player,1,["ACE_SelfActions",_category,"arsenalCategory"],_saveRespawnLoadout] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category,"arsenalCategory"],_loadRespawnLoadout] call ace_interact_menu_fnc_addActionToObject;
...
private _deploy = [
	...
	YMF_fnc_initDeployMenu,
	{
		...
		{[player,50] call FUNC(isNearFOB) || _isNearMobileRespawn || player distance (markerPos "respawn") < 50}
	}
] call ace_interact_menu_fnc_createAction;
[player,1,["ACE_SelfActions",_category],_deploy] call ace_interact_menu_fnc_addActionToObject;
...
private _crateCategory = [
	...
	{
		(rankId player > 3 || (player call admp_fnc_isAdmin)) &&
		{[player,50] call FUNC(isNearFOB)}
	}
	] call ace_interact_menu_fnc_createAction;
[player,1,["ACE_SelfActions",_category],_crateCategory] call ace_interact_menu_fnc_addActionToObject;
...
private _logisticsCategory = [
	...
	{},
	{
		rankId player > 1  || {(player call admp_fnc_isAdmin)}
	}
] call ace_interact_menu_fnc_createAction;
[player,1,["ACE_SelfActions",_category],_logisticsCategory] call ace_interact_menu_fnc_addActionToObject;
...
private _buildMenu = [
	...
	{
		isNull objectParent player &&
		{[player] call FUNC(isNearFOB)}
	}
] call ace_interact_menu_fnc_createAction;
[player,1,["ACE_SelfActions",_category,"logisticsCategory"],_buildMenu] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category,"logisticsCategory"],_environmentMenu] call ace_interact_menu_fnc_addActionToObject;
...
private _factoryMenu = [
	...
	YMF_fnc_initFactoryMenu,
	{
		...
		{(rankId player > 2 || (player call admp_fnc_isAdmin)) &&
		{([player] call FUNC(isNearFOB) || [player,[["factory"],true] call YMF_fnc_getSectorsByType] call YMF_fnc_isNearSector)}}
	}
] call ace_interact_menu_fnc_createAction;
[player,1,["ACE_SelfActions",_category,"logisticsCategory"],_factoryMenu] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category,"logisticsCategory"],_logisticsMenu] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category,"logisticsCategory"],_retrieveCrates] call ace_interact_menu_fnc_addActionToObject;
...
private _createNewFOB = [
	...
	{
		(rankId player > 2 || (player call admp_fnc_isAdmin)) &&
		{!([player,(getNumber(missionConfigFile >> "Settings" >> "fobBuildRadius")) * 2] call FUNC(isNearFOB))}
	}
] call ace_interact_menu_fnc_createAction;
{
...
[player,1,["ACE_SelfActions",_category],_guerillaMenu] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category],_intelMenu] call ace_interact_menu_fnc_addActionToObject;
...
[player,1,["ACE_SelfActions",_category,"intelMenu"],_cancelMission] call ace_interact_menu_fnc_addActionToObject;