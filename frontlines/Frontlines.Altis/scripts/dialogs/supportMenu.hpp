class YMF_supportMenu : RscDisplayTeamSwitch
{
	idd=9646;
	name="YMF_supportMenu";
	movingEnable=0;
	onLoad = "";
	...
	class Controls : Controls
	{
		...
		{
			idc = 1500;
			onTreeSelChanged = "_this call YMF_fnc_onSupportMenuTvChange;";
		...
		class SupportMap: RscMapControl
		{
			...
			onMouseButtonDown = "_this call YMF_fnc_onSupportMapPress";
		};
		...
		class SelectSupportBtn : CA_ButtonContinue
		{
			idc = 2400;
			text = "Select";
			onButtonClick = "[] call YMF_fnc_startSupport;";
		};
