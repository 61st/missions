 ...
 *
 * Example:
 * [this] call YMF_fnc_vehicle_setupPylonCategories;
 *
 * Public: No
 */
...
private _vehiclePylon = [QEGVAR(Actions_Vehicle,Pylon_Cat), "Vehicle Loadouts", "", {true}, { [player,50] call FUNC(isNearFOB)}] call ace_interact_menu_fnc_createAction;
