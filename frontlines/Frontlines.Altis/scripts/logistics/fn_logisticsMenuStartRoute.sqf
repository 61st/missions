...
if (_totalToMove isEqualTo 0) exitWith {["Nothing to move."] call YMF_fnc_notify};
...
[_from,_to,_requiredTrucks,CBA_missionTime,_arrivalTime,[_suppliesToMove,_fuelToMove,_ammoToMove],_travelFuel,_fromIndex] remoteExecCall ["YMF_fnc_logisticsStartRoute",2];
["Request sent."] call YMF_fnc_notify;
