...
_mapControl ctrlAddEventHandler ["MouseButtonDown",{
	...
	if (_type isEqualTo "marker") then {
		private _factories = [["factory"],true] call YMF_fnc_getSectorsByType;
		private _factoryIndex = _factories findIf {_x getVariable ["YMF_sectorVariable",""] isEqualTo _value};
