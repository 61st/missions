class Dynamic_Groups { //format: {"Group Name",{"Roles"},"Conditions for the group to be shown"}
    ...
    group_setup[] = {
        ...
        {"29th Airmobile",{"sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogarmyteam1","sogmed1","sogmed1","sogmed1","sogmed1"},"true"},
