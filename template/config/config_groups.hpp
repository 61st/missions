...
class Dynamic_Groups { //format: {"Group Name",{"Roles"},"Conditions for the group to be shown"}
	faction_name = "61st";
	group_setup[] = {
		{"Outlaw 1-1",{"squadlead11","jtac11","engineer11","medic11","teamlead11","dismount11","dismount11","dismount11"},"true"},
		{"Wardaddy 1-1",{"cmd1","driver1","gunner1"},"true"},
		{"Outlaw 1-2",{"squadlead12","jtac12","engineer12","medic12","teamlead12","dismount12","dismount12","dismount12"},"true"},
