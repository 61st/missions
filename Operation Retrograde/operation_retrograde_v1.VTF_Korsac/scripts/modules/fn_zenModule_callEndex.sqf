 ...
 *
 * Example:
 * [getPos logic, this] call  YMF_fnc_zenModule_callEndex;
 *
 * Public: No
 */
...
[
    ...
    ], 
    {
        ...
        private _image = "<img size='5' image='z\lxim\addons\media\images\logo_512.paa' align='center'/><br /><br />";
            ...
            [
                {
                    [{
                        ...
                        private _fn_handleDischarge = {
                            ...
                            private _hfimage = "<img size='5' image='z\lxim\addons\media\images\logo_512.paa' align='center'/><br /><br />";
