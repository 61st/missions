class squadleadr {
    ...
    defaultLoadout[] = {
        ...
        {"B_simc_US_Molle_sturm_OCP_RTO_wasser",{{"psq42_blk",1},{"ACM_ChestSeal",2},{"lxim_medbags_FirstAid",2},{"ACM_SAMSplint",2},{"ACE_EntrenchingTool",1},{"ACE_Fortify",1},{"JCA_G_AirPurifyingRespirator_03_black_clear_F",1},{"ACE_IR_Strobe_Item",1},{"ACE_SpraypaintBlue",1},{"ACE_HuntIR_monitor",1}}},
