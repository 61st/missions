 ...
 *
 * Example:
 * call YMF_fnc_init_aceItemReplace
 *
 * Public: No
 */
...
switch (EGVAR(Settings,replacerhs_mag_m67s)) do {
    case (1): {["rhs_mag_m67","rhs_mag_m67"] call ace_common_fnc_registerItemReplacement};
    case (2): {["rhs_mag_m67","rhs_mag_m67"] call ace_common_fnc_registerItemReplacement};
};
