 ...
 *
 * Example:
 * [myTruck] call YMF_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call YMF_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call YMF_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call YMF_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call YMF_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
