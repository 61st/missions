 ...
 *
 * Example:
 * ["B_supplyCrate_F"] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", false] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", false, MyTruck] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", false, [255,300,2]] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", [["ACE_personalAidKit", 8], ["ACE_tourniquet", 10]]] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", [["ACE_personalAidKit", 8], ["ACE_tourniquet", 10]], MyTruck] call YMF_fnc_createCargoCrate;
 * ["B_supplyCrate_F", [["ACE_personalAidKit", 8], ["ACE_tourniquet", 10]], [255,300,2]] call YMF_fnc_createCargoCrate;
 *
 * Public: Yes
 */
...
if (!isNil{_resize}) then {
    [_crate, -1, _resize] call YMF_fnc_setCargoAttributes;
};
