...
class roleClassname { //this class is used when defining which roles are in what group
    ...
    defaultLoadout[] = { // https://community.bistudio.com/wiki/Unit_Loadout_Array but with {}'s not []'s
        ...
        {},
        {"hgun_P07_snds_F","muzzle_snds_L","","",{"CUP_17Rnd_9x19_M17_Black",16},{},""},
        {"U_B_Wetsuit",{{"FirstAidKit",1},{"30Rnd_556x45_Stanag_red",3,30},{"20Rnd_556x45_UW_mag",2,20},{"CUP_17Rnd_9x19_M17_Black",2,16},{"SmokeShellBlue",2,1},{"Chemlight_blue",4,1}}},
        {"V_RebreatherB",{}},
