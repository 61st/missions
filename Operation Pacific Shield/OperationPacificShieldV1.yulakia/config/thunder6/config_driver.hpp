class driver6 {
	name = "Crew Driver";
    description = "Deforestation in progress";
    traits[] = {
        {"Engineer",true}
	};
	customVariables[] = {
    ...
    defaultLoadout[] = {
            ...
            {"B_simc_US_Molle_sturm_OCP_RTO_wasser",{{"psq42_blk",1},{"ToolKit",1},{"ACE_IR_Strobe_Item",1},{"B_IR_Grenade",1},{"ACE_EntrenchingTool",1}}},"H_HelmetCrew_I","G_tweed_ESS_Green",{"ACE_Vector","","","",{},{},""},
