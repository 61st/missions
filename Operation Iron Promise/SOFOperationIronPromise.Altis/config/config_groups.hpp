class Dynamic_Groups { //format: {"Group Name",{"Roles"},"Conditions for the group to be shown"}
    ...
    group_setup[] = {
        ...
        {"Seal-Team-1",{"sealteam1","sealteam1","sealteam1","sealmed1","sealteam1","sealteam1","sealteam1","sealteam1","sealteam1","sealteam1"},"true"},
        {"Seal Team-2",{"sealteam2","sealteam2","sealteam2","sealmed2","sealteam2","sealteam2","sealteam2","sealteam2","sealteam2","sealteam2"},"true"},
