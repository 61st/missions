class squadleadr {
    ...
    defaultLoadout[] = {
            ...
            {"TFAR_rt1523g_fabric",{{"ToolKit",1},{"ACE_Fortify",1},{"ACE_wirecutter",1},{"ACE_DefusalKit",1},{"MineDetector",1},{"ACE_Clacker",1},{"rhs_mag_rgd5",2,1},{"SmokeShell",2,1},{"DemoCharge_Remote_Mag",2,1}}},
