[
	...
	["Enemy_Mortars", "Enemy Mortars", 5, [], "Kill", TRUE, "Mortars Killed!", ["O_Mortar_01_F", "O_Mortar_01_F", "O_Mortar_01_F", "O_Mortar_01_F"] , TRUE, TRUE, "Border", "ELLIPSE", getMarkerPos "ZONE_RADIUS", TRUE, [["PATH", FALSE]], FALSE ]
