class teamlead12r {
    ...
    customVariables[] = {
		...
		{"diwako_dui_indicators_customIcon", "a3\ui_f\data\map\vehicleicons\iconmanleader_ca.paa", true},
        {"sixone_teamcolor", "RED", true}
	};
    icon = "z\sixtyone\addons\media\images\Icons\iconmanleader_red.paa";
...
class teamlead12b {
    ...
    icon = "z\sixtyone\addons\media\images\Icons\iconmanleader_blue.paa";
