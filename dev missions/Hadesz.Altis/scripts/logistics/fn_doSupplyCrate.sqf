 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call sixone_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medicalAtlas"] call sixone_fnc_doSupplyCrate;
 */
...
if (typeOf _crate in _smallBox) then {
    _crate setObjectTextureGlobal  [0, "\scripts\Data\Images\AmmoBox_signs_sixone_ammo_CA.paa"];
};
if (typeOf _crate in _largeBox) then {
    _crate setObjectTextureGlobal  [1, "\scripts\Data\Images\AmmoBox_signs_sixone_ammo_CA.paa"];
};
