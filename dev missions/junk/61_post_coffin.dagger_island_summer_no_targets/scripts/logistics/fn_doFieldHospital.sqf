 ...
 * This scripts crate the LXIF field hostpital.
 ...
 *
 * Example:
 * [this] call lxif_fnc_doFieldHospital;
 * [this, true, 1] call lxif_fnc_doFieldHospital;
 */
...
_crate addAction ["<img image='scripts\Data\Icon\icon_00.paa' /> LXIF Field Hospital", {}, [], 1.5, true, true, "", "true", 5];
