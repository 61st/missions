...
private _stagingZoneMarkers = [];
{
    ...
    if (_markerName in ["zone_staging", "respawn_west", "lxif_staging_zone"]) then {
...
// addAction notice
player addAction [
    "<img image='scripts\Data\Icon\icon_00.paa' /> <t color='#ffc61a'>LXIF Staging Zone</t> <img image='scripts\Data\Icon\icon_00.paa' />",
    {
...
/* range init ------------------------------------------------------------------------------------------------------------ */
        private _rangecat = [
                ...
                "ReInit Ranges",
                "",
                {[] execVM "config\range_init.sqf";},
                _conditionr
        ] call ace_interact_menu_fnc_createAction;
        [player,1,_category,_rangecat] call ace_interact_menu_fnc_addActionToObject;
...
/* arsenal ---------------------------------------------------------------------------------------------------------- */
	...
	["ace_arsenal_displayClosed",{
		LXIF_savedLoadout = getUnitLoadout player;
