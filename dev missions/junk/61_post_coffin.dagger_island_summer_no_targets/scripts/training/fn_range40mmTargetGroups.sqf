...
{
    [_x, 1] call LXIMFUNC(shootingrange,animateTarget);
} forEach [ALL_TARGETS];
//////////////
...

{
    ...
    private _action = [
        ...
        "x\cba\addons\ai\iconinvisibletarget.paa",
        {
            ...
            {
                [_x, _state] call LXIMFUNC(shootingrange,animateTarget);
                _x setVariable [QLXIMGVAR(shootingrange,stayDown), true, true];
