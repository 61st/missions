class Dynamic_Roles {
    ...
    #include "outlaw_hq\config_officer_xo.hpp"
    #include "outlaw_hq\config_medic.hpp"
    #include "outlaw_hq\config_jfire.hpp"
    #include "outlaw_hq\config_nco.hpp"
...
class Common_Arsenal {
	weapons[] = {
        ...
        "sixtyone_equipment_xm157_prototype",
        "sixtyone_equipment_optic_DMS",
        "sixtyone_equipment_optic_Nightstalker",
        "sixtyone_equipment_optic_AMSTI_snd",
        "sixtyone_equipment_optic_AMSTI_khk",
        "sixtyone_equipment_optic_AMSTI",
        "sixtyone_equipment_optic_AMS_snd",
        "sixtyone_equipment_optic_AMS_khk",
        "sixtyone_equipment_optic_AMS",
