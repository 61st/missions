...
private _stagingZoneMarkers = [];
{
    ...
    if (_markerName in ["zone_staging", "respawn_west", "sixone_staging_zone"]) then {
...
// addAction notice
player addAction [
    "<img image='scripts\Data\Icon\icon_00.paa' /> <t color='#ffc61a'>SIXONE Staging Zone</t> <img image='scripts\Data\Icon\icon_00.paa' />",
    {
...
/* arsenal ---------------------------------------------------------------------------------------------------------- */
	...
	["ace_arsenal_displayClosed",{
		SIXONE_savedLoadout = getUnitLoadout player;
