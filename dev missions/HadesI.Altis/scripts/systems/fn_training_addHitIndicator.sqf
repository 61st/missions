...
/*
 * Author: CPL.Brostrom.A -- Tinkered with by YonV tinkered with by YonV, Ocean.M
 ...
 *
 * Example:
 * [this] call Sixone_fnc_training_addHitIndicator;
 * [this, myOtherTarget] call Sixone_fnc_training_addHitIndicator;
 * [this, myOtherTarget, "#(argb,8,8,3)color(1,0.6,0.1,1.0,ca)"] call Sixone_fnc_training_addHitIndicator;
 * [this, myOtherTarget, "#(argb,8,8,3)color(1,0.1,0.6,1.0,ca)"] call Sixone_fnc_training_addHitIndicator;
 */
