class SIXONE_groupMenu : RscDisplayTeamSwitch
{
	idd=9702;
	name="SIXONE_groupMenu";
	movingEnable=0;
	onLoad = "";
	onUnload = "";
	class Controls : Controls
	{
		...
		{
			text = "$STR_SIXONE_Role_Menu_Title";
		};
		class RoleList : RscTree
		{
			idc = 1500;
			onTreeSelChanged = "_this call SIXONE_fnc_onGroupMenuTvSelectChange;";
		...
		class SelectRoleBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call SIXONE_fnc_selectPosition;";
		};
	};
};