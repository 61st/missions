class crewchief {
    ...
    defaultLoadout[] = {
            ...
            {"B_tweed_pack_wasser_molle_ocp",{{"ACE_Canteen",1},{"ACE_Chemlight_Shield",1},{"ACE_DefusalKit",1},{"ACE_Flashlight_MX991",1},{"CUP_NVG_GPNVG_black",1},{"ACE_CableTie",4},{"ACE_Flashlight_XL50",1},{"ACE_MapTools",1},{"kat_AFAK",1},{"SmokeShellGreen",1,1},{"ACE_HandFlare_Green",1,1},{"MS_Strobe_Mag_1",5,1}}},
