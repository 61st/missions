 ...
 * [this,"none",true] call YMF_fnc_doStarterCrate;
 * [this,"none",true,true,true,false,false] call YMF_fnc_doStarterCrate;
 * [this,"none",true,true,true,false,false,true] call YMF_fnc_doStarterCrate;
 *
 */
...
_object addAction [format ["<img image='YMF\Data\Icon\icon_00.paa' /> 61st Mechanized%1Equipment Crate", _crateName], {}, [], 1.5, true, true, "", "true", 5];
