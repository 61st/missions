// [player, false, false] execvm "ROS_GroupHalo\smoke-purple.sqf";

params ["_unit", "_triColor","_attachToChute"];
...
if (_attachToChute) then {
    _emitter attachto [vehicle _unit, [0,-2.45,5.6]];
} else {
    _emitter attachTo [ _unit, [0, -0.1, 0], "lankle"];
};
