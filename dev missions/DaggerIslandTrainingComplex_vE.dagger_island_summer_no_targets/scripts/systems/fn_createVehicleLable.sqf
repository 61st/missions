 ...
 *
 * Example:
 * ["UH60", [-0.49,-2.45,-1.3], 87, "path/to/texture.paa"] call YMF_fnc_createVehicleLable
 * ["C130", [0.205,-11.9,8.920],-90,  "path/to/texture.paa", [-0.05,0,1]] call YMF_fnc_createVehicleLable
 * ["Stryker", [1.666,-1.32,-0.42] , false, "path/to/texture.paa", [[-1,0,-0.152], [0,0,1]]] call YMF_fnc_createVehicleLable;
 *
 */
