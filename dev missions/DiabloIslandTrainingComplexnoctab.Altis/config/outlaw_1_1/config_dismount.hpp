class dismount11 {
	...
	defaultLoadout[] = {
			...
			{"V_tweed_msv_mk2_1",{{"CUP_17Rnd_9x19_M17_Black",3,17},{"SmokeShell",2,1},{"HandGrenade",2,1},{"SPS_20Rnd_762x51mm_M80A1_EPR",12,20}}},
			{"B_simc_US_Molle_sturm_OCP_thermos_od7",{{"ACE_EntrenchingTool",1},{"ACE_Flashlight_MX991",1},{"ACE_wirecutter",1},{"ACE_Fortify",1},{"kat_IFAK",1},{"ACE_EarPlugs",2},{"ACE_CableTie",5},{"kat_gasmaskFilter",2},{"kat_mask_M50",1},{"psq42_blk",1}}},"H_tweed_ihps_g_tasc_rail","G_comba_1_cut",
