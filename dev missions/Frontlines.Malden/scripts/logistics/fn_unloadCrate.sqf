...
if (isEngineOn _vehicle) exitWith {["Turn off the engine before unloading crates."] call YMF_fnc_notify};
...
_vehicle setVariable ["YMF_loadedCrates",nil,true];
_vehicle allowDamage true;
["Vehicle unloaded."] call YMF_fnc_notify;