class YMF_intelMenu : RscDisplayTeamSwitch
{
	idd=9647;
	name="YMF_intelMenu";
	movingEnable=0;
	...
	class Controls : Controls
	{
		class Title : CA_TSTitle
		{
			...
			onLoad = "_this select 0 ctrlSetText format ['Intelligence Menu - Intel Count: %1',YMF_intelCount]";
		};
		class IntelligenceList : RscTree
		{
			idc = 1500;
			onTreeSelChanged = "_this call YMF_fnc_onIntelMenuTvChange;";
		...
		class SelectSupportBtn : CA_ButtonContinue
		{
			idc = 2400;
			text = "Select";
			onButtonClick = "[] call YMF_fnc_startIntelAction;";
		};
	};
};