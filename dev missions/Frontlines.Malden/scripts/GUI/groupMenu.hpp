class YMF_groupMenu : RscDisplayTeamSwitch
{
	idd=9702;
	name="YMF_groupMenu";
	movingEnable=0;
	...
	class Controls : Controls
	{
		...
		{
			text = "$STR_YMF_Role_Menu_Title";
		};
		class RoleList : RscTree
		{
			idc = 1500;
			onTreeSelChanged = "_this call YMF_fnc_onGroupMenuTvSelectChange;";
		...
		class SelectRoleBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call YMF_fnc_selectPosition;";
		};
	};
};