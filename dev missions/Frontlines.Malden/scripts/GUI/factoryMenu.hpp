class YMF_factoryMenu : RscDisplayTeamSwitch
{
	idd=9643;
	name="YMF_factoryMenu";
	movingEnable=0;
	onLoad = "";
	onUnload = "";
	class Controls : Controls
	{
		...
		{
			idc = 1500;
			onLbSelChanged = "_this call YMF_fnc_onFactoryMenuLbChange;";
		...
		class ConfirmBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call YMF_fnc_updateFactory;";
		};
