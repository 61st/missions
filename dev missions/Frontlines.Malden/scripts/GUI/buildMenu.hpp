class YMF_buildMenu : RscDisplayTeamSwitch
{
	idd=9641;
	name="YMF_buildMenu";
	movingEnable=0;
	...
	class controls : Controls
	{
		...
		class BuildList : YMF_RscTreeSearch
		{
			idc = 1500;
			onTreeSelChanged = "_this call YMF_fnc_onBuildMenuTvChange;";
		...
		class SelectVehicleBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call YMF_fnc_startBuild;";
		};
