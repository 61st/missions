	...
	/*
		...
		Format is:
		{
			"Category Title",
			{
				...
				{{"B_Slingload_01_Cargo_F", "FOB Container"}, {300,500,0}, "(count YMF_allFOBs) < (getNumber(missionConfigFile >> 'Settings' >> 'maxFobs'))"}
			}
		}
	*/
	bluforBuyables[] = {
		...
		},
		{
			"Air Vehicles",
			{
				{"B_UAV_01_F", {50,100,0}, ""},
				{"B_UAV_06_F", {75,100,0}, ""},
				{"B_UAV_02_dynamicLoadout_F", {300,200,200}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {YMF_globalReputation > 25 && {call YMF_fnc_getMissionProgress > 0.35}}"},
				{"B_UAV_05_F", {300,300,250}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {YMF_globalReputation > 25 && {call YMF_fnc_getMissionProgress > 0.35}}"},
				{"B_T_UAV_03_dynamicLoadout_F", {500,300,350}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {YMF_globalReputation > 25 && {call YMF_fnc_getMissionProgress > 0.35  && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}}}"},

				{"B_Heli_Light_01_F", {200,150,0}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},
				{"B_Heli_Light_01_dynamicLoadout_F", {250,150,150}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},

				{"B_Heli_Transport_03_F", {300,200,250}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},
				{"B_Heli_Transport_01_F", {200,200,100}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},
				{"B_CTRG_Heli_Transport_01_sand_F", {200,200,100}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},
				{"B_CTRG_Heli_Transport_01_tropic_F", {200,200,100}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentHelicopters',[]]) < YMF_maxHelicopterCount}"},

				{"B_T_VTOL_01_infantry_F", {600,300,0}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentPlanes',[]]) < YMF_maxPlaneCount}"},
				{"B_T_VTOL_01_vehicle_F", {600,300,0}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentPlanes',[]]) < YMF_maxPlaneCount}"},
				{"B_T_VTOL_01_armed_F", {600,300,700}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentPlanes',[]]) < YMF_maxPlaneCount}"},

				{"B_Plane_Fighter_01_F", {900,800,800}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentPlanes',[]]) < YMF_maxPlaneCount && {call YMF_fnc_getMissionProgress > 0.4}}"},
				{"B_Plane_CAS_01_dynamicLoadout_F", {800,800,900}, "missionNamespace getVariable ['YMF_canPurchaseAir',false] && {count (missionNamespace getVariable ['YMF_currentPlanes',[]]) < YMF_maxPlaneCount && {call YMF_fnc_getMissionProgress > 0.35}}"}
			}
		},
		{
			"Naval Vehicles",
		...
		},
		{
			...
			{
				{{"B_Slingload_01_Cargo_F", "FOB Container"}, {300,500,0}, "(count YMF_allFOBs) < (getNumber(missionConfigFile >> 'Settings' >> 'maxFobs'))"},
				{{"B_Truck_01_box_F", "FOB Truck"}, {350,500,0}, "(count YMF_allFOBs) < (getNumber(missionConfigFile >> 'Settings' >> 'maxFobs'))"},
				...
				{{"C_IDAP_Truck_02_water_F", "Relief Truck"}, {50,50,0}, "missionNamespace getVariable [""YMF_secondaryActive"",""""] isEqualTo ""humanitarianRelief"""},
				{{"Land_PortableWeatherStation_01_olive_F", "Listening Post"}, {250,0,0}, "missionNamespace getVariable [""YMF_secondaryActive"",""""] isEqualTo ""listeningPost"""}
			}
		}
	};
