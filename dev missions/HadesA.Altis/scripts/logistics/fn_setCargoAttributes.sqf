 ...
 *
 * Example:
 * [myTruck] call sixone_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call sixone_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call sixone_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call sixone_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call sixone_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
