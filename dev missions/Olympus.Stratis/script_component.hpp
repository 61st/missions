...
#define SIXTYONEFUNC(var1,var2) TRIPLES(DOUBLES(tac,var1),fnc,var2)

#define SIXTYONEGVAR(var1,var2) TRIPLES(tac,var1,var2)
#define QSIXTYONEGVAR(var1,var2) QUOTE(SIXTYONEGVAR(var1,var2))
