...
{
    [_x, 1] call SIXTYONEFUNC(shootingrange,animateTarget);
} forEach [ALL_TARGETS];
//////////////
...

{
    ...
    private _action = [
        ...
        "x\cba\addons\ai\iconinvisibletarget.paa",
        {
            ...
            {
                [_x, _state] call SIXTYONEFUNC(shootingrange,animateTarget);
                _x setVariable [QSIXTYONEGVAR(shootingrange,stayDown), true, true];
