...
#define LXIMFUNC(var1,var2) TRIPLES(DOUBLES(LIXM,var1),fnc,var2)
#define LXIMGVAR(var1,var2) TRIPLES(LIXM,var1,var2)
#define QLXIMGVAR(var1,var2) QUOTE(LXIMGVAR(var1,var2))
