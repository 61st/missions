 ...
 *
 * Example:
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [], ""] call lxif_fnc_vehicle_addPylonSelection;
 * [_vehicle, _displayName, _vehicleKind, _loadoutName, _pylon, _icon] call lxif_fnc_vehicle_addPylonSelection;
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [_vehicle, "rhsusf_m1a1tank_base", "default"] call lxif_fnc_vehicle_getPylon, ""] call lxif_fnc_vehicle_addPylonSelection;
 *
 * Public: No
 */
