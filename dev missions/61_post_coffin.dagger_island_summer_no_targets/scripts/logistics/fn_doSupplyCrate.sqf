 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call lxif_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medicalAtlas"] call lxif_fnc_doSupplyCrate;
 */
...
if (typeOf _crate in _smallBox) then {
    _crate setObjectTextureGlobal  [0, "\scripts\Data\Images\AmmoBox_signs_lxif_ammo_CA.paa"];
};
if (typeOf _crate in _largeBox) then {
    _crate setObjectTextureGlobal  [1, "\scripts\Data\Images\AmmoBox_signs_lxif_ammo_CA.paa"];
};
