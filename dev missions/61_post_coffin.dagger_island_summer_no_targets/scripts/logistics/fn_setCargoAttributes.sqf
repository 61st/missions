 ...
 *
 * Example:
 * [myTruck] call lxif_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call lxif_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call lxif_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call lxif_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call lxif_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
