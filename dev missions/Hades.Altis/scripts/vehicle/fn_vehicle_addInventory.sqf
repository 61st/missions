 ...
 *
 * Example:
 * [_vehicle] call sixone_fnc_vehicle_addInventory;
 *
 * Public: No
 */
...
if (_vehicle iskindOf "Heli_Transport_01_base_F") then {
    switch (_vehicleType) do {
        ...
        case "sixone_helicopters_B_Heli_Transport_01_F_medic"; 
...
if (_vehicle iskindOf "Heli_Transport_03_base_F") then {
    switch (_vehicleType) do {
        case "sixone_helicopters_B_Heli_Medevac_031_F";
        case "sixone_helicopters_B_Heli_Medevac_03dazt_F";
        case "sixone_helicopters_B_Heli_Medevac_03daz_F"; 
        case "MED": {
            [_vehicle, 
                GET_CONTAINER("helo_medical")
            ] call FUNC(setCargo);
