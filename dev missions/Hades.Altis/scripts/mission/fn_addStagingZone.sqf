 ...
 *
 * Example:
 * [this] call sixone_fnc_addStagingZone
 * [this, 3] call sixone_fnc_addStagingZone
 * ["zone_staging", 12] call sixone_fnc_addStagingZone
 * ["respawn_west", 12] call sixone_fnc_addStagingZone
 * [[10,25,0], 12] call sixone_fnc_addStagingZone
 * ["ShapedZoneMarker", "RECTANGLE"] call sixone_fnc_addStagingZone
 * ["ShapedZoneMarker", "ELLIPSE"] call sixone_fnc_addStagingZone
 * 
 * Public: Yes
 */
...
if (_zone isEqualType []) exitWith {
    ...
    private _stagingZone = createMarkerLocal [format["sixone_staging_zone_%1", count _stagingZones], _zonePos];
