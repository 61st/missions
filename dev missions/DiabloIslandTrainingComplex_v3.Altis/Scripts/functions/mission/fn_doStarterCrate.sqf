...
* This Scripts crate the 61st Mechanized Infantry Battalion starter crate.
 ...
 * 4: Show all Loadouts <BOOL>      (Default: false)
 * 5: Arsenal <BOOL>                (Default: false)
 ...
 *
 * Example:
 * [this] call Scripts_fnc_doStarterCrate;
 * [this,"none",true] call Scripts_fnc_doStarterCrate;
 * [this,"none",true,true,false,false] call Scripts_fnc_doStarterCrate;
 * [this,"none",true,true,false,false,true] call Scripts_fnc_doStarterCrate;
 *
 */
...
_object addAction [format ["<img image='Scripts\Data\Icon\icon_00.paa' /> 61st Mechanized Infantry Battalion%1Equipment Crate", _crateName], {}, [], 1.5, true, true, "", "true", 5];
