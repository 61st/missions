 ...
 *
 * Example:
 * [this] call Scripts_fnc_addStagingZone
 * [this, 3] call Scripts_fnc_addStagingZone
 * ["zone_staging", 12] call Scripts_fnc_addStagingZone
 * ["respawn_west", 12] call Scripts_fnc_addStagingZone
 * [[10,25,0], 12] call Scripts_fnc_addStagingZone
 * ["ShapedZoneMarker", "RECTANGLE"] call Scripts_fnc_addStagingZone
 * ["ShapedZoneMarker", "ELLIPSE"] call Scripts_fnc_addStagingZone
 * 
 * Public: Yes
 */
...
if (_zone isEqualType []) exitWith {
    ...
    private _stagingZone = createMarkerLocal [format["Scripts_staging_zone_%1", count _stagingZones], _zonePos];
