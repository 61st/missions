...
private _stagingZoneMarkers = [];
{
    ...
    if (_markerName in ["zone_staging", "respawn_west", "Scripts_staging_zone"]) then {
...
// addAction notice
player addAction [
    "<img image='Scripts\Data\Icon\icon_00.paa' /> <t color='#ffc61a'>61st Mechanized Infantry Battalion Staging Zone</t> <img image='Scripts\Data\Icon\icon_00.paa' />",
    {
