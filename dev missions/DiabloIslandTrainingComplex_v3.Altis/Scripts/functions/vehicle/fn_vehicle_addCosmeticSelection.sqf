 ...
 *
 * Example:
 * [_vehicle] call Scripts_fnc_vehicle_addCosmeticSelection;
 *
 * Public: No
 */
...

{
    ...
    if (_vehicle isKindOf _classname) then {
        ...
        private _action = [format ["Scripts_Cosmetic_%1_%2", _classname, _forEachIndex], _displayName, "", _statement, {true}, nil, _textureCode] call ace_interact_menu_fnc_createAction;
