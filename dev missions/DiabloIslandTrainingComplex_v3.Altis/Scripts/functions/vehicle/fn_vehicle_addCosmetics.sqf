 ...
 *
 * Example:
 * [_vehicle] call Scripts_fnc_vehicle_addCosmetics;
 *
 * Public: No
 */
    ...
    switch (_vehicle getVariable [QEGVAR(Vehicle,Callsign), 0]) do {
        ...
        case 3: {
            [_vehicle, [
                ...
                [12, "\z\lxim\addons\media\images\vehicles\abrams\BarrelArt_IronCladLads_ca.paa"]
            ]] call EFUNC(vehicle,applyTextures);
        ...
        case 4: {
            [_vehicle, [
                ...
                [12, "\z\lxim\addons\media\images\vehicles\abrams\BarrelArt_WarSaw_ca.paa"]
            ]] call EFUNC(vehicle,applyTextures);
