 ...
 *
 * Example:
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [], ""] call Scripts_fnc_vehicle_addPylonSelection;
 * [_vehicle, _displayName, _classname, _pylonName, _loadout _icon] call Scripts_fnc_vehicle_addPylonSelection;
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [_vehicle, "rhsusf_m1a1tank_base", "default"] call Scripts_fnc_vehicle_getPylon, ""] call Scripts_fnc_vehicle_addPylonSelection;
 *
 * Public: No
 */
