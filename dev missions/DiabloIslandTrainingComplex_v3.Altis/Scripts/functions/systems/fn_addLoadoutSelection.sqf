 ...
 * 4: Categorys <ARRAY>                         (Optional)  [Default: ["ACE_MainActions","Scripts_Loadout_Cat_Main"]]
 * 5: Company required to use                   (Optional)  [Default: ""]
 * 6: Allow All Loadouts <BOOL>                 (Optional)  [Default: false]
 *
 * Example:
 * [this,"Rifleman","Class_Rifleman"] call Scripts_fnc_addLoadoutSelection;
 * [this,"Rifleman","Class_Rifleman","",["ACE_MainActions","Scripts_Loadout_Cat_Main"],""] call Scripts_fnc_addLoadoutSelection;
 * [this,"Rifleman","Class_Rifleman","",["ACE_MainActions","Scripts_Loadout_Cat_Main"],"", false] call Scripts_fnc_addLoadoutSelection;
 * 
 * Public: No
 */
...
params [
    ...
    ["_className", "", [""]],
    ["_icon", "", [""]],
    ["_category", ["ACE_MainActions", "Scripts_Loadout_Cat_Main"], [[]]],
    ["_company", "", [""]],
    ["_platoon", 0, [0]],
...
private _action = [format ["Scripts_Loadout_%1", _className], _lable, _icon, {
    params ["", "", "_params"];
