 ...
 *
 * Example:
 * [this] call Scripts_fnc_training_addHitIndicator;
 * [this, myOtherTarget] call Scripts_fnc_training_addHitIndicator;
 * [this, myOtherTarget, "#(argb,8,8,3)color(1,0.6,0.1,1.0,ca)"] call Scripts_fnc_training_addHitIndicator;
 * [this, myOtherTarget, "#(argb,8,8,3)color(1,0.1,0.6,1.0,ca)"] call Scripts_fnc_training_addHitIndicator;
 */
