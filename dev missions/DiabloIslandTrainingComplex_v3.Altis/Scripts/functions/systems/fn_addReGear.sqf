 ...
 *
 * Example:
 * [this] call Scripts_fnc_addReGear
 * [this] call Scripts_fnc_addReGear
 * [this, ["ACE_MainActions"]] call Scripts_fnc_addReGear
 */
...
private _regearAction = ["ScriptsReGearAce", "ReGear", _Icon, _regearStatement, {true}] call ace_interact_menu_fnc_createAction;
