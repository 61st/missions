...
<br/><br/>
-----------------------------------------------------------------
<br/><br/>This mission is currently running Scripts version: <font color='#ffc61a'>%8</font>."];

player createDiaryRecord["61st", ["Information", _document], taskNull, "", false];
