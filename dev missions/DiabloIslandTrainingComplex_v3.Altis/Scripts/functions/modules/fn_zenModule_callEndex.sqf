 ...
 *
 * Example:
 * [getPos logic, this] call Scripts_fnc_zenModule_callEndex;
 *
 * Public: No
 */
...
[
    ...
    ], 
    {
        ...
        private _image = "<img size='5' image='Scripts\Data\Images\logo_512.paa' align='center'/><br /><br />";
                ...
                {
                    {
                        [
                            ...
                            "fired",
                            {
                                ...
                                private _hfimage = "<img size='5' image='Scripts\Data\Images\logo_512.paa' align='center'/><br /><br />";
