 ...
 * This Scripts crate the 61st Mechanized Infantry Battalion field hostpital.
 ...
 *
 * Example:
 * [this] call Scripts_fnc_doFieldHospital;
 * [this, true, 1] call Scripts_fnc_doFieldHospital;
 */
...
_crate addAction ["<img image='Scripts\Data\Icon\icon_00.paa' /> 61st Mechanized Infantry Battalion Field Hospital", {}, [], 1.5, true, true, "", "true", 5];
