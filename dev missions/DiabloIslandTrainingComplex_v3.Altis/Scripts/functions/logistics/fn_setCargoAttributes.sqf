 ...
 *
 * Example:
 * [myTruck] call Scripts_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call Scripts_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call Scripts_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call Scripts_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call Scripts_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
