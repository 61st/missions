 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call Scripts_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medicalAtlas"] call Scripts_fnc_doSupplyCrate;
 */
...
//     _crate setObjectTextureGlobal  [0, "\z\cav\addons\supplies\data\Ammobox_61ST_co.paa"];
// };
// if (typeOf _crate in _largeBox) then {
//     _crate setObjectTextureGlobal  [1, "\z\cav\addons\supplies\data\Ammobox_61ST_co.paa"];
// };
