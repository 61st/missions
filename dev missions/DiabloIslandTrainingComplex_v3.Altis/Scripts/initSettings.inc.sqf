private _Scriptsettings = "Scripts Mission Settings";
...
[ // Enable
    ...
    [_Scriptsettings, "6; Item Replacement"],
    true,
    true,
    {},
    true
...
[ // Simulation Type
    ...
    [_Scriptsettings, "7; Combat Jump Simulation"],
...
[ // Enable Custom Zeus Moduels
    QEGVAR(Settings,enable61STZeusModules),
    "CHECKBOX",
    ["Enable Custom Zeus Moduels","Allow mission to add 61ST moduels using the Achilles or ZEN framework."],
    [_Scriptsettings, "8; Zeus"],
    true,
    true,
    {},
    true
