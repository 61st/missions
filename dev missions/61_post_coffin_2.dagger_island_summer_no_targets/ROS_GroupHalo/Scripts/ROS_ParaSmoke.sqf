...
if (_RWBSmoke) then {
	waitUntil {animationState _unit == 'para_pilot'};
	[_unit,true,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-blue.sqf";
	[_unit,true,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-white.sqf";
	[_unit,true,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-red.sqf";
} else {
	if (_colorSmoke isEqualTo "blue") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-blue.sqf"};
	if (_colorSmoke isEqualTo "white") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-white.sqf"};
	if (_colorSmoke isEqualTo "red") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-red.sqf"};
	if (_colorSmoke isEqualTo "yellow") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-yellow.sqf"};
	if (_colorSmoke isEqualTo "purple") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-purple.sqf"};
	if (_colorSmoke isEqualTo "green") then {[_unit,false,_attachToChute] execvm "ROS_GroupHalo\scripts\smoke-green.sqf"};
};
