...
this addAction ["<t color='#3399ff'>Weather Report</t>", "ROS_GroupHalo\scripts\ROS_weatherReport.sqf",[], 1.3, false, false,"","_this distance _target < 3"];
...
// Transfer all Halo (AI and player) units to plane
{
	...
	if (_enableSmoke) then {
		[[_x],"ROS_GroupHalo\scripts\ROS_ParaSmoke.sqf"] remoteExec ["execVM", _x];
	};
	sleep 0.1;
